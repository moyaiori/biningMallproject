...
<div class="btn-group col-md-12 col-md-offset-3" role="group">
  <button type="button" class="btn btn-danger">나의 정보</button>
  <button type="button" class="btn btn-danger">정보 수정</button>
  <button type="button" class="btn btn-danger">나의 배송</button>
</div>
