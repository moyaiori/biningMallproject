	...
	<tr><td  class ="" colspan="3" align="center" bordercolor="red" ></td></tr>
		...
		<c:forEach begin="0" end="2" var="i">
				<td align=center valign=top width="25%" style="padding-bottom:25px;">
						...
						<div><a  href="../product/product_view.bins?productId=${productList.get(i).productId}" style="display:inline-block; color:#000; font-size:11px; padding:0 0 3px 0;">${productList.get(i).name}</a></div>
