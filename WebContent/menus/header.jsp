    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <!-- <li><a href="../notice/notice.bins"><h4>Bin's Berger 공지사항</h4></a></li> -->
          <li><button onclick="location.href='../notice/notice.bins' "><h4>Bin's Berger 공지사항</h4>
        <li><button onclick="location.href='../product/product_list_berger.bins' "><h4>Bin's Berger 버거</h4>    </button> <!-- <a href="../product/product_list_berger.bins"><h4>Bin's Berger 버거</h4></a></li> -->
